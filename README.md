...
Stuff I can do sort of okay:
[![My Skills](https://skillicons.dev/icons?i=html,css,python,js,neovim,arch,raspberrypi)](https://skillicons.dev)

Stuff I'm not 100% on but comfortable messing around with:
[![things i'm comfortable messing around with](https://skillicons.dev/icons?i=vite,react,vue,ts,sass,bootstrap,lua,svg,tailwind)](https://skillicons.dev)
